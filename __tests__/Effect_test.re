...
//       ),
//     )
//   | Increment => Effect.perform(const(increment), Effect.sleep(1000))
//   | Decrement
//   | FetchOver(_) => Effect.none;
// let reducer = state =>
//   fun
//   | Fetch => state
...
//   let dispatchWithEffect = effects(state)->Effect.apply(dispatch);
//   <div>
